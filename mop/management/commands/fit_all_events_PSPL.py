       ...
       for target in list_of_targets:
           ...
           try:    
               ...
               if 'Microlensing' not in target.extra_fields['Classification']:
                   ...
                   t0_fit,u0_fit,tE_fit,piEN_fit,piEE_fit,mag_source_fit,mag_blend_fit,mag_baseline_fit,cov,model = fittools.fit_PSPL_parallax(target.ra, target.dec, photometry,cores = 3)
